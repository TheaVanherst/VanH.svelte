...
const
    notices =
        [
            ...
            "Various progress steps that is done through commissioning will be forwarded to my " +
            ...
            "This also applies to Photoshop files.",
    ...
    howToCom =
        [
            "Commissions are only accessible via openings, or for mutuals. Openings are then done in " +
            "stages, going through the various steps until all slots are filled.",
