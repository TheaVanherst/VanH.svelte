...
const
    ...
    navigationControls =    writable({ direction: [0,0], nsfw: false, loaded: false, transitioning: true, localNsfwCheck: (e) => !e && !navigationControls.nsfw || e }),
...
const
    directoryProcessing = async (p, c, f = 0) => {
